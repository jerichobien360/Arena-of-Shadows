...
def main():
    ...
    panels = [PanelTemplates.game_settings_panel(), PanelTemplates.quest_panel()]
    current_panel_idx = 0
    panel_pos = (400, 100)
    ...
    instructions = [
        "Click 'Switch Panel' to toggle between Settings and Quest Creator",
    ...
    while True:
        for event in pygame.event.get():
            ...
            panels[current_panel_idx].handle_event(event, panel_pos)
        ...
        panels[current_panel_idx].draw(screen, panel_pos)
        
        # Draw instructions
        for i, instruction in enumerate(instructions):
            text = button_font.render(instruction, True, (200, 200, 200))
            screen.blit(text, (50, 700 + i * 25))
